sap.ui.define(
	...
	function(UIComponent){
		return UIComponent.extend("manoj.app.Component",{
			metadata: {
				manifest: "json"
			},
			init: function(){
			...
			// 		viewName: "manoj.app.view.View1",
			// 		type: "XML"
			// 	});
			
			// 	var oView2 = new sap.ui.view("idView2",{
			// 		viewName: "manoj.app.view.View2",
			// 		type: "XML"
			// 	});
			// 	var oEmpty = new sap.ui.view("idEmpty",{
			// 		viewName: "manoj.app.view.Empty",
			// 		type: "XML"
			// 	});
